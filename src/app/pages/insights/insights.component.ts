...
export class InsightsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  insights: any = [{
    ...
    explorePdf: "https://wingmanapi.rbprojects.me/public/uploads/anouncementPdf/1619163024.pdf"
  }, {
    ...
    explorePdf: "https://wingmanapi.rbprojects.me/public/uploads/anouncementPdf/1619162839.pdf"
  }, {
    ...
    explorePdf: "https://wingmanapi.rbprojects.me/public/uploads/anouncementPdf/1619162787.pdf"
  }
  ];
